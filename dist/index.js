"use strict";var v=function(a,e){return function(){try{return e||a((e={exports:{}}).exports,e),e.exports}catch(i){throw (e=0, i)}};};var o=v(function(A,l){
var j=require('@stdlib/number-float64-base-to-float32/dist'),b=require('@stdlib/math-base-special-absf/dist'),f=require('@stdlib/math-base-assert-is-nanf/dist');function R(a,e,i,c){var s,n,t,r,u;if(a<=0)return NaN;if(a===1||i===0)return f(e[c])?NaN:0;if(t=c,r=e[t],f(r))return r;for(n=b(r),s=n,u=1;u<a;u++){if(t+=i,r=e[t],f(r))return r;r=b(r),r<n?n=r:r>s&&(s=r)}return j(s-n)}l.exports=R
